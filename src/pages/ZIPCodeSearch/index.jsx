...
import { Img, Input, Text, Button, SelectBox, List, Line } from "components";
...
const ZIPCodeSearchPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_50 flex flex-col font-gilroy sm:gap-[40px] md:gap-[40px] gap-[70px] items-center justify-start mx-[auto] pb-[195px] w-[100%]">
        ...
        <div className="flex md:flex-col flex-row gap-[28px] items-start justify-start max-w-[1264px] mx-[auto] md:px-[20px] w-[100%]">
          ...
          <div className="flex md:flex-1 flex-col items-start justify-start md:w-[100%] w-[50%]">
            ...
            <div className="flex flex-col font-gilroy gap-[13px] items-start justify-start mt-[30px] md:w-[100%] w-[66%]">
              <Text
              ...
              <div className="flex flex-col gap-[18px] items-start justify-start pt-[4px] w-[100%]">
                ...
                <div className="flex flex-row gap-[8px] items-start justify-start md:w-[100%] w-[45%]">
                  <Img
                  ...
                  />
                  <Text
                    className="font-medium mt-[2px] text-blue_A700 text-left w-[auto]"
                    variant="body4"
                  >
