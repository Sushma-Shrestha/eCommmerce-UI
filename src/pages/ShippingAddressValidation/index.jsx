...
const ShippingAddressValidationPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_50 flex flex-col font-gilroy sm:gap-[40px] md:gap-[40px] gap-[70px] items-center justify-start mx-[auto] pb-[272px] w-[100%]">
        ...
        <div className="flex md:flex-col flex-row gap-[28px] items-start justify-start max-w-[1268px] mx-[auto] md:px-[20px] rounded-[8px] w-[100%]">
          <div className="bg-white_A700 flex md:flex-1 items-center justify-start p-[16px] rounded-[8px] shadow-bs md:w-[100%] w-[68%]">
          ...
          <div className="bg-white_A700 flex md:flex-1 flex-col gap-[32px] items-center justify-start mb-[279px] p-[16px] rounded-[8px] shadow-bs md:w-[100%] w-[31%]">
            <div className="flex flex-col items-start justify-start md:w-[100%] w-[92%]">
              ...
              <div className="flex flex-row gap-[68px] items-center justify-start mt-[15px] md:w-[100%] w-[94%]">
                <Text
                  className="font-medium text-black_902 text-left w-[auto]"
                  as="h5"
                  variant="h5"
